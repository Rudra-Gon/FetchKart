...
VALUES ('FIRSTFETCH', 'percentage', 75.00, 200.00),
...
ADD COLUMN IF NOT EXISTS `godown_id` int(11) DEFAULT NULL;
ALTER TABLE `products`
ADD CONSTRAINT `fk_product_godown` FOREIGN KEY (`godown_id`) REFERENCES `godowns`(`id`) ON DELETE
SET NULL;